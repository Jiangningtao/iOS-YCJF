...
//    self.innerCircleLayer.fillColor = LIGHTBLUE.CGColor;
    self.outlineLayer.strokeColor = [UIColor colorWithRed:74/255.0 green:130/255.0 blue:225/255.0 alpha:1/1.0].CGColor;
    self.innerCircleLayer.fillColor = [UIColor colorWithRed:74/255.0 green:130/255.0 blue:225/255.0 alpha:1/1.0].CGColor;
}
...
//        _outlineLayer.strokeColor = LIGHTBLUE.CGColor;
        _outlineLayer.strokeColor = [UIColor colorWithRed:74/255.0 green:130/255.0 blue:225/255.0 alpha:1/1.0].CGColor;
...
-(CAShapeLayer *)innerCircleLayer
{
    if (_innerCircleLayer == nil) {
        ...
        _innerCircleLayer.strokeColor = [UIColor lightGrayColor].CGColor;
        _innerCircleLayer.lineWidth = 2.0f;
