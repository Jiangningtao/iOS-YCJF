...
@interface zhangdanViewController ()<UIScrollViewDelegate>
/***标签栏底部的红色指示器 ***/
...
-(void)setupChildVces
{
    daishouzdViewController *daishou = [[daishouzdViewController alloc]init];
    daishou.title = @"待收账单";
    
    [self addChildViewController:daishou];
    
    yishouzdViewController *yishou = [[yishouzdViewController alloc]init];
    yishou.title = @"已收账单";
    
    [self addChildViewController:yishou];
