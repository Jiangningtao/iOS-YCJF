...
#import "myjjModel.h"
@interface yiguoqiViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation yiguoqiViewController
...
//    cell.biaojiimgV.image = [UIImage imageNamed:@"pic_yiguoqi"];
